...
function Form() {
  ...
  return (
    <motion.div
      data-testid="form"
      id="form"
      className="w-[60%] md:w-[30%] bg-form rounded-2xl shadow-2xl p-6"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    >
      <h1 className="text-3xl text-center mb-6">Resume submission form</h1>
      ...
      <div className="grid gap-3">
        <div>
          <Box
            component="form"
            sx={{
              '& > :not(style)': { marginY: '10px', width: '32ch', display: 'flex', flexDirection: 'col' },
            }}
            noValidate
            autoComplete="off"
          >
        ...
        <div>
          <FormControl component="fieldset">
            <RadioGroup row aria-label="gender" name="gender" value={selected} onChange={handleChangeGender}>
              <FormControlLabel
                value="woman"
        ...
        <div>
          ...
          >
            <h3 className="text-gray-400 text-center text-sm hover:text-blue-400 transition-colors duration-300">
              {fileSelected ? 
